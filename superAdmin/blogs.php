...
<html class="uk-height-1-1">
    ...
    <body id="page-blogs"> 
        ...
        <h2 class="page-header"><span data-lang>Blog articles</span> <span class="uk-margin-left page-sparkline" data-table="blogs"></span></h2>
        ...
        <script> 
            $("#blogs").DataTable({
            	...
            	stateSave: true,
            	columns: [
            		{ data:"is_active", title:(lang["Vis"]||"Vis"), width:"1em", class:"uk-text-center", render:function(d,t,r){
            		...
            		{ data:"id", title:(lang["ID"]||"ID"), width:"1em", class:"id"},
            		...
            		{ data:"image", title:(lang["Image"]||"Image"), width:"1em"},
            		{ data:"title", title:(lang["Title"]||"Title"), class:"uk-nowrap", render:function(d,t,r){return d.replace(/^(.{45}[^\s]*).*/, "$1...")} },
            		...
            		{ data:"subtitle", title:(lang["Subtitle"]||"Subtitle"),render:function(d,t,r){return d.replace(/^(.{45}[^\s]*).*/, "$1...")  }},
            		{ data:"author", title:(lang["Author"]||"Author")},
            	...
            	buttons: [{	text:(lang["New"]||"New"), className:"uk-button uk-button-primary",
                	init: function(dt, node, conf){ node.attr("data-uk-modal",true).attr("href","#modal-new-blogcontent").attr("data-populate",'{"id":"0"}'); } 
            	}],
        ...
        <div>
            ...
            <div id="modal-edit-blogcontent" class="uk-modal" data-get="ajax.php?f=blogs/getBlog" data-hide-on-submit>
                <div class="uk-modal-dialog uk-modal-dialog-large">
                    ...
                    <div class="uk-modal-header"> <h3><span data-lang>Edit article</span>: #<b class="uk-text-muted" name="id"></b> </h3></div>
                    
                    <form class="uk-form uk-form-horizontal" action="ajax.php?f=blogs/postEditBlog" data-trigger="blog-changed,blog-addnew1">
                        <input type="hidden" name="id">
                        <article class="uk-article">
                            <h1 name="title" class="uk-width-1-1 uk-article-title editable" id="edit-title" data-lang
                                data-tinymce
                                data-inline="true"
                            ...
                            <div class="uk-article-lead uk-width-1-1 editable" name="subtitle" id="edit-subtitle" data-lang
                                data-tinymce
                                data-inline="true"
                                data-toolbar="undo,redo"
                                data-menubar="false"
                            ...
                            <div class="uk-article-meta">
                                <span data-lang>Written by</span> <b name="author"></b> <span data-lang>on</span> <input type="date" name="date">. <span data-lang>Posted in</span> <select data-get="ajax.php?f=blogs/getCategories&forselect" name="id_category"></select>
                            </div>
                            
                            <div class="uk-article-divider"></div>                        
                            
                            <div name="content" class="uk-width-1-1 edit uk-margin-top uk-margin-bottom editable" id="edit-content" data-lang 
                                data-tinymce    
                                data-inline="true"
                        ...
                        <div class="uk-article-divider"></div>
                            ...
                            <div class="uk-form-row">
                                <label class="uk-form-label"><span data-lang>SEO Tags</span>  <span class="uk-text-danger">*</span></label>
            ...
            <?php /*** Modal NEW */?>
            <div id="modal-new-blogcontent" class="uk-modal" data-hide-on-submit>
                <div class="uk-modal-dialog uk-modal-dialog-large">
                    <a class="uk-modal-close uk-close"></a>
                    <div class="uk-modal-header"> <h3><span data-lang>New article</span></h3></div>
                    
                    <form class="uk-form uk-form-horizontal" action="ajax.php?f=blogs/postNewBlog" data-trigger="blog-addnew">
                        <input type="hidden" name="id">
                        <article class="uk-article">
                            <h1 id="new-title" name="title" class="uk-width-1-1 uk-article-title editable" data-lang
                                data-tinymce
                                data-inline="true"
                                data-toolbar="undo,redo"
                                data-menubar="false"
                            ...
                            <div class="uk-article-lead uk-width-1-1 editable" id="new-subtitle" name="subtitle" data-lang
                                data-tinymce
                                data-inline="true"
                                data-toolbar="undo,redo"
                                data-menubar="false"
                            ...
                            <div id="new-content" name="content" class="uk-width-1-1 edit uk-margin-top uk-margin-bottom editable"  data-lang
                                data-tinymce    
                                data-inline="true"
                                data-plugins='["advlist autolink lists link image charmap print preview anchor","searchreplace visualblocks code fullscreen","insertdatetime media table contextmenu paste code imagetools"]'
                                data-toolbar= 'insertfile undo redo | styleselect | bold italic | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent | link image' 
                                data-imagetools_cors_hosts='["www.tinymce.com","codepen.io"]'
                            ><i class="uk-icon-external-link"></i> <span data-lang>A long, long article content goes here.</span></div>
                            ...
                            <div class="uk-form-row">
                                ...
                                <div class="uk-form-controls">
                                    <select class="uk-width-1-1 select2" style="width:100%" 
                                                ...
                                                name="tags[]"
                                            ></select>
                                    <p class="uk-form-help-block"><span data-lang>Separate tags with</span> <code data-lang>comma</code>, <code data-lang>space</code> <span data-lang>or</span> <code data-lang>&lt;Еnter&gt;</code>.</p>
                                </div>
                            </div>
